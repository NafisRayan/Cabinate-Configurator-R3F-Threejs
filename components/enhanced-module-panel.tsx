  ...
  return (
    <Card className="m-4">
      ...
      <CardContent className="space-y-4">
        ...
        {selectedCell ? (
          <div>
            <div className="text-xs text-muted-foreground mb-3 p-2 bg-accent rounded">
              <strong>Selected Cell:</strong> Row {selectedCell.row + 1}, Col {selectedCell.col + 1}
              <br />
              <span className="text-xs text-muted-foreground">Click categories below to add modules</span>
            </div>
                      ...
                      >
                        <div className="flex items-center gap-2 w-full">
                          ...
                          <div className="flex-1">
                            <div className="font-medium text-foreground">{moduleType.name}</div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="font-medium text-xs truncate text-foreground">{moduleType?.name}</div>
